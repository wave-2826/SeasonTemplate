...
public class Drive extends SubsystemBase implements Vision.VisionConsumer {
    ...
    public static Translation2d[] getModuleTranslations() {
        return DriveConstants.moduleConfigs.stream()
            .map(config -> new Translation2d(config.xPosition.in(Meters), config.yPosition.in(Meters)))
